...
subprojects {
    ...
    aliucord {
        author("cakes", 147709526357966848)
        updateUrl.set("https://raw.githubusercontent.com/Kex1016/AliucordPlugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/Kex1016/AliucordPlugins/builds/%s.zip")
    }
